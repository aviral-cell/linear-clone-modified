      ...
      {isEditable ? (
        <>
          ...
          <textarea
            ...
            className="w-full bg-transparent text-text-primary focus:outline-none resize-none placeholder-text-tertiary text-sm min-h-[80px]"
            rows={4}
          />
          {showPostButton && content && content.trim() && (
